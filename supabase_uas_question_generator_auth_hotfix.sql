...
-- HOTFIX AUTENTIKASI RPC GENERATOR SOAL UAS TAHAP 6A
-- File: supabase_uas_question_generator_auth_hotfix.sql
--
-- Deskripsi:
-- Hotfix ini HANYA mengganti 3 Stored Procedure RPC UAS:
-- 1. generate_uas_question_set
-- 2. regenerate_uas_question_set
-- 3. get_uas_question_set
--
-- Perbaikan:
-- Menggunakan pola autentikasi canonical SITA pada tabel users:
-- (password = p_password OR password = extensions.crypt(p_password, password))
--
-- TIDAK ADA perubahan schema/tabel. Aman dieksekusi pada database LIVE.
-- ============================================================
