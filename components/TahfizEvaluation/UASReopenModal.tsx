...
interface UASReopenModalProps {
  student: ExaminerStudentItem;
  onReopen: (attemptId: string, reason: string) => Promise<void>;
  onClose: () => void;
}

export const UASReopenModal: React.FC<UASReopenModalProps> = ({
  student,
  onReopen,
  onClose
}) => {
      ...
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-100 overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b border-amber-100 bg-amber-50/70 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-slate-800 text-sm">Buka Kembali Ujian UAS</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Contoh: Koreksi kekeliruan input poin tajwid pada soal nomor 1 atau 2 atas konfirmasi penguji."
              rows={3}
              required
