...
interface UTSAssignExaminerModalProps {
  periodId: string;
...
export const UTSAssignExaminerModal: React.FC<UTSAssignExaminerModalProps> = ({
  periodId,
  student,
  teachers,
  onAssign,
      ...
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-100 overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-slate-800 text-sm">Tugaskan Penguji UTS</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-slate-500 mb-2">
              Guru penguji yang ditugaskan akan memiliki hak akses membuka dan menilai paket soal santri ini.
            </p>
          ...
          {isInProgress && (
            <div className="space-y-1.5 p-3 rounded-xl bg-amber-50 border border-amber-200">
              ...
              <textarea
                ...
                rows={2}
                required
                className="w-full text-xs p-2.5 rounded-lg border border-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white text-slate-800"
              />
            </div>
          )}
          ...
          <div className="pt-2 flex items-center justify-end gap-2 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl text-xs font-bold text-white bg-teal-600 hover:bg-teal-700 disabled:opacity-50 transition-all shadow-sm"
            >
